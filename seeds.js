...
{
  "title": "KINGS DAY",
  "description": "Every year on April 27 Amsterdam turns a very bright shade of orange for King’s Day, which is the King’s birthday. It’s a crazy fun celebration when the center of the city is basically car, tram, and bike-free simply because there are too many people on foot. It has a contagious festival-like atmosphere with street vendors, a market day when anyone can sell pretty much anything, and an insane boat parade party on the canals that will have you dancing unconsciously. It’s a festival that can put a smile on everyone’s face!",
  "type": "Religious_Traditional",
  "start": "2018-04-27",
  "end": "2018-04-27",
  "country": "Netherlands",
...
{
  "title": "GLASTONBURY",
  "description": "Even though it only exists for a week every year, Glastonbury is one of my favourite places on earth. 150,000 people come together to listen to great music, dress up in silly outfits and have a wonderful time on a farm in Somerset. Yes, it can be muddy and rainy and wet but it’s a festival like no other.Whichever way your musical tastes lean, there will be something to suit, plus there’s theatre, comedy, parties and film showings when you decide you’ve had enough of the music.",
  "type": "Music",
  "start": "2019-06-21",
  "end": "2019-06-25",
  "country": "UK",
...

{
  ...
  "description": "With the rise in popularity of animated films, western cartoons and Anime as well as video games and other fantasy novels, the franchise of Comicon has been growing over the years since the 70’s. Basically, this festival features a four-day event that is held at San Diego Convention Center in California. A wide variety of different genre in the fantasy world are all over the place during the whole event. The cool part here is not just meeting your idols but also by partaking in the hype of the fantasy world by cosplaying your favorite characters, talking with strangers and making friends with the same enthusiasm with you.",
  "type": "Film",
  "start": "2017-07-20",
  "end": "2017-07-23",
  "country": "USA",
...

{
  ...
  "description": "The dates vary slightly each year the festival typically runs from September to mid-November, which is the most wonderful time of the year at Disney! On top of the 11 countries permanently represented in EPCOT’s World Showcase, the festival highlights food and beverage offerings from 19 other nations at themed stalls. In addition, they offer seminars and demonstrations from famous chefs, wine tastings, and even film ABC’s The CHEW on site.",
  "type": "Food_and_Drink",
  "start": "2017-08-31",
  "end": "2017-11-13",
  "country": "USA",
